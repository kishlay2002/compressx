  ...
  return (
    <Card className="w-full max-w-md shadow-xl shadow-primary/5 border-border/50">
      ...
      <CardContent className="pt-4">
        <Button
          variant="outline"
          className="w-full h-11 text-sm font-medium border-2 hover:bg-muted/50"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <div className="text-sm text-destructive text-center bg-destructive/5 rounded-lg py-2.5 px-3">
              {error}
            </div>
          )}
